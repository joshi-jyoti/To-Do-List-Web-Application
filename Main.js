...
class TodoManager {
  ...
  searchTodos(query) {
    ...
    return this.todos.filter((todo) => todo.task.toLowerCase().includes(q));
  }
  //
...
class UIManager {
  ...
  addEventListeners() {
    ...
    this.searchBtn.addEventListener("click", () => {
      ...
      this.handleTodosSearch(searchText);
    });
    //
  }
  ...
  // Search Bar
  handleTodosSearch(query) {
    const searchedTodos = this.todoManager.searchTodos(query);
    this.displayTodos(searchedTodos);
  }
  // Search Bar
